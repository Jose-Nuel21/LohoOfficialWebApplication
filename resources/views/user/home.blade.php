            ...
            <div id="rev_slider_2_1" class="rev_slider fullwidthabanner tp-overflow-hidden display_none" data-version="5.2.6">
                <ul>
                    ...
                    <li data-index="rs-4"
                        ...
                        data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('assets/images/slider1-3.jpg')}}" alt="" title="slider1-3" width="1920" height="768" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                    ...
                    <li data-index="rs-5"
                        ...
                        data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('assets/images/slider1-2.jpg')}}" alt="" title="slider1-2" width="1924" height="768" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption tp-resizeme" id="slide-5-layer-1" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-6','0','0','0']" data-width="none" data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;" data-transform_in="y:-50px;opacity:0;s:1200;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;" data-start="500" data-responsive_offset="on">
                            <img src="{{asset('assets/images/slider1-2_layer.png')}}" alt="" width="543" height="500" data-ww="['543px','543px','543px','404px']" data-hh="['500px','500px','500px','378px']" data-no-retina>
                        </div>
                    </li>
                    <!-- SLIDE  -->
                    <li
                        ...
                        data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('assets/images/home1_sl2.png')}}" alt="" title="home1_sl2" width="1920" height="768" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                            ...
                            <div class="sc_countdown sc_countdown_style_2 aligncenter" data-date="2017-05-01" data-time="12:00:00">
                                <div class="sc_countdown_inner">
                                    ...
                                    <div class="sc_countdown_item sc_countdown_hours">
                                        ...
                                        <span class="sc_countdown_label">Hours</span></div>
                                    <div class="sc_countdown_separator">:</div>
                    ...
                    <li data-index="rs-7"
                        ...
                        data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('assets/images/slider1_1.png')}}" alt="" title="slider1_1" width="1924" height="768" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption tp-resizeme" id="slide-7-layer-1" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['1','1','0','0']" data-width="none" data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;" data-transform_in="x:{-250,250};y:{-150,150};rX:{-90,90};rY:{-90,90};rZ:{-360,360};sX:0;sY:0;opacity:0;s:1200;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;" data-start="500" data-responsive_offset="on">
                            <img src="{{asset('assets/images/slider1-1_layer.png')}}" alt="" width="631" height="595" data-ww="['631px','631px','631px','401']" data-hh="['595px','595px','595px','359']" data-no-retina> </div>
                    </li>
                </ul>
                              ...
                              <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
                                <figure class="sc_image sc_image_shape_square">
                                    <a href="service-single.html">
                                        <img src="{{asset('assets/images/church_foto.jpg')}}" alt="" />
                                    </a>
                                </figure>
                            ...
                            <ul>
                                ...
                                <li class="filterall filter-home-1 eg-washington-wrapper">
                                    ...
                                    <div class="esg-media-cover-wrapper">
                                        ...
                                        <div class="esg-entry-media">
                                            <img src="{{asset('assets/images/truth-does-not-hurt.jpg')}}" alt="">
                                        </div>
                                        ...
                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                            ...
                                            <div class="esg-center eg-washington-element-0-a esg-falldown" data-delay="0.1">
                                                <a class="eg-washington-element-0 esgbox" href="{{asset('assets/images/truth-does-not-hurt.jpg')}}">
                                ...
                                <li class="filterall filter-home-1 eg-washington-wrapper">
                                    ...
                                    <div class="esg-media-cover-wrapper">
                                        <!-- THE MEDIA OF THE ENTRY -->
                                        <div class="esg-entry-media">
                                            <img src="{{asset('assets/images/we-give-hope.jpg')}}" alt="">
                                        </div>
                                        <!-- THE CONTENT OF THE ENTRY -->
                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                            <!-- THE COLORED OVERLAY -->
                                            <div class="esg-overlay esg-fade eg-washington-container" data-delay="0"></div>
                                            <div class="esg-center eg-washington-element-0-a esg-falldown" data-delay="0.1">
                                                <a class="eg-washington-element-0 esgbox" href="{{asset('assets/images/we-give-hope.jpg')}}" >
                                                    <i class="eg-icon-search"></i>
                                                </a>
                                            </div>
                                            <div class="esg-center eg-washington-element-1-a esg-falldown" data-delay="0.2">
                                ...
                                <li class="filterall filter-home-1 eg-washington-wrapper">
                                    ...
                                    <div class="esg-media-cover-wrapper">
                                        <!-- THE MEDIA OF THE ENTRY -->
                                        <div class="esg-entry-media">
                                            <img src="{{asset('assets/images/gallery-post-4.jpg')}}" alt="">
                                        </div>
                                        <!-- THE CONTENT OF THE ENTRY -->
                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                            <!-- THE COLORED OVERLAY -->
                                            <div class="esg-overlay esg-fade eg-washington-container" data-delay="0"></div>
                                            <div class="esg-center eg-washington-element-0-a esg-falldown" data-delay="0.1">
                                                <a class="eg-washington-element-0 esgbox" href="{{asset('assets/images/gallery-post-4.jpg')}}">
                                                    <i class="eg-icon-search"></i>
                                                </a>
                                            </div>
                                            <div class="esg-center eg-washington-element-1-a esg-falldown" data-delay="0.2">
                                ...
                                <li class="filterall filter-home-1 eg-washington-wrapper">
                                    ...
                                    <div class="esg-media-cover-wrapper">
                                        <!-- THE MEDIA OF THE ENTRY -->
                                        <div class="esg-entry-media">
                                            <img src="{{asset('assets/images/Depositphotos_31241887_l.jpg')}}" alt="">
                                        </div>
                                        <!-- THE CONTENT OF THE ENTRY -->
                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                            <!-- THE COLORED OVERLAY -->
                                            <div class="esg-overlay esg-fade eg-washington-container" data-delay="0"></div>
                                            <div class="esg-center eg-washington-element-0-a esg-falldown" data-delay="0.1">
                                                <a class="eg-washington-element-0 esgbox" href="{{asset('assets/images/Depositphotos_31241887_l.jpg')}}">
                                                    <i class="eg-icon-search"></i>
                                                </a>
                                            </div>
                                            <div class="esg-center eg-washington-element-1-a esg-falldown" data-delay="0.2">
                                ...
                                <li class="filterall filter-home-1 eg-washington-wrapper">
                                    ...
                                    <div class="esg-media-cover-wrapper">
                                        <!-- THE MEDIA OF THE ENTRY -->
                                        <div class="esg-entry-media">
                                            <img src="{{asset('assets/images/who-we-are.jpg')}}" alt="">
                                        </div>
                                        <!-- THE CONTENT OF THE ENTRY -->
                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                            <!-- THE COLORED OVERLAY -->
                                            <div class="esg-overlay esg-fade eg-washington-container" data-delay="0"></div>
                                            <div class="esg-center eg-washington-element-0-a esg-falldown" data-delay="0.1">
                                                <a class="eg-washington-element-0 esgbox" href="{{asset('assets/images/who-we-are.jpg')}}">
                                                    <i class="eg-icon-search"></i>
                                                </a>
                                            </div>
                                            <div class="esg-center eg-washington-element-1-a esg-falldown" data-delay="0.2">
                                ...
                                <li class="filterall filter-home-1 eg-washington-wrapper">
                                    ...
                                    <div class="esg-media-cover-wrapper">
                                        <!-- THE MEDIA OF THE ENTRY -->
                                        <div class="esg-entry-media">
                                            <img src="{{asset('assets/images/find-love-inside-yourself.jpg')}}" alt="">
                                        </div>
                                        <!-- THE CONTENT OF THE ENTRY -->
                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                            <!-- THE COLORED OVERLAY -->
                                            <div class="esg-overlay esg-fade eg-washington-container" data-delay="0"></div>
                                            <div class="esg-center eg-washington-element-0-a esg-falldown" data-delay="0.1">
                                                <a class="eg-washington-element-0 esgbox" href="{{asset('assets/images/find-love-inside-yourself.jpg')}}">
                                                    <i class="eg-icon-search"></i>
                                                </a>
                                            </div>
                                            <div class="esg-center eg-washington-element-1-a esg-falldown" data-delay="0.2">
                                ...
                                <li class="filterall filter-home-1 eg-washington-wrapper">
                                    ...
                                    <div class="esg-media-cover-wrapper">
                                        <!-- THE MEDIA OF THE ENTRY -->
                                        <div class="esg-entry-media">
                                            <img src="{{asset('assets/images/Depositphotos_31241887_l2.jpg')}}" alt="">
                                        </div>
                                        <!-- THE CONTENT OF THE ENTRY -->
                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                            <!-- THE COLORED OVERLAY -->
                                            <div class="esg-overlay esg-fade eg-washington-container" data-delay="0"></div>
                                            <div class="esg-center eg-washington-element-0-a esg-falldown" data-delay="0.1">
                                                <a class="eg-washington-element-0 esgbox" href="images/Depositphotos_31241887_l2.jpg">
                                                    <i class="eg-icon-search"></i>
                                                </a>
                                            </div>
                                            <div class="esg-center eg-washington-element-1-a esg-falldown" data-delay="0.2">
                                ...
                                <li class="filterall filter-home-1 eg-washington-wrapper">
                                    ...
                                    <div class="esg-media-cover-wrapper">
                                        <!-- THE MEDIA OF THE ENTRY -->
                                        <div class="esg-entry-media">
                                            <img src="{{asset('assets/images/our-community.jpg')}}" alt="">
                                        </div>
                                        <!-- THE CONTENT OF THE ENTRY -->
                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                            <!-- THE COLORED OVERLAY -->
                                            <div class="esg-overlay esg-fade eg-washington-container" data-delay="0"></div>
                                            <div class="esg-center eg-washington-element-0-a esg-falldown" data-delay="0.1">
                                                <a class="eg-washington-element-0 esgbox" href="images/our-community.jpg">
                                                    <i class="eg-icon-search"></i>
                                                </a>
                                            </div>
                                            <div class="esg-center eg-washington-element-1-a esg-falldown" data-delay="0.2">
                                ...
                                <li class="filterall filter-home-1 eg-washington-wrapper">
                                    ...
                                    <div class="esg-media-cover-wrapper">
                                        <!-- THE MEDIA OF THE ENTRY -->
                                        <div class="esg-entry-media">
                                            <img src="{{asset('assets/images/5-questions-for-decision-makers.jpg')}}" alt="">
                                        </div>
                                        <!-- THE CONTENT OF THE ENTRY -->
                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                            <!-- THE COLORED OVERLAY -->
                                            <div class="esg-overlay esg-fade eg-washington-container" data-delay="0"></div>
                                            <div class="esg-center eg-washington-element-0-a esg-falldown" data-delay="0.1">
                                                <a class="eg-washington-element-0 esgbox" href="images/5-questions-for-decision-makers.jpg">
                                                    <i class="eg-icon-search"></i>
                                                </a>
                                            </div>
                                            <div class="esg-center eg-washington-element-1-a esg-falldown" data-delay="0.2">
                                ...
                                <li class="filterall filter-home-1 eg-washington-wrapper">
                                    ...
                                    <div class="esg-media-cover-wrapper">
                                        <!-- THE MEDIA OF THE ENTRY -->
                                        <div class="esg-entry-media">
                                            <img src="{{asset('assets/images/what-we-believe.jpg')}}" alt="">
                                        </div>
                                        <!-- THE CONTENT OF THE ENTRY -->
                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                            <!-- THE COLORED OVERLAY -->
                                            <div class="esg-overlay esg-fade eg-washington-container" data-delay="0"></div>
                                            <div class="esg-center eg-washington-element-0-a esg-falldown" data-delay="0.1">
                                                <a class="eg-washington-element-0 esgbox" href="images/what-we-believe.jpg">
                                                    <i class="eg-icon-search"></i>
                                                </a>
                                            </div>
                                            <div class="esg-center eg-washington-element-1-a esg-falldown" data-delay="0.2">
                                                <a class="eg-washington-element-1" href="{{asset('assets/images/what-we-believe.jpg" target="_self')}}">
                                                    <i class="eg-icon-link"></i>
                                                </a>
                                            </div>
                                            <div class="esg-center eg-washington-element-8 esg-none esg-clear"></div>
                            ...
                            <div class="content_wrap">
                                <div class="columns_wrap">
                                    <div class="sc_call_to_action_featured column-1_2">
                                        <img alt="" src="{{asset('assets/images/guitarhero-520x320.jpg')}}">
                                                    ...
                                                    <div class="post_featured">
                                                        ...
                                                        <div class="post_thumb" data-title="Small Group Leader Training">
                                                            <a class="hover_icon hover_icon_link" href="post-single.html">
                                                                <img alt="Small Group Leader Training" src="{{asset('assets/images/small-group-leader-training-370x209.jpg')}}">
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="post_item post_item_classic post_item_classic_3	even">
                                                    <div class="post_featured">
                                                        ...
                                                        <div class="post_thumb" data-title="The Power of Scripture">
                                                            <a class="hover_icon hover_icon_link" href="post-single.html">
                                                                <img alt="The Power of Scripture" src="{{asset('assets/images/participate-with-us-370x209.jpg')}}">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="post_content isotope_item_content">
                                                ...
                                                <div class="post_item post_item_classic post_item_classic_3 odd">
                                                    <div class="post_featured">
                                                        ...
                                                        <div class="post_thumb" data-title="Be Inspired by Biblical Teaching">
                                                            <a class="hover_icon hover_icon_link" href="post-single.html">
                                                                <img alt="Be Inspired by Biblical Teaching" src="{{asset('assets/images/be-inspired-by-biblical-teaching-370x209.jpg')}}">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="post_content isotope_item_content">
                                                ...
                                                <div class="post_item post_item_classic post_item_classic_3	even">
                                                    <div class="post_featured">
                                                        ...
                                                        <div class="post_thumb" data-title="Listen to the Wind Words, the Spirit blowing through the churches.">
                                                            <a class="hover_icon hover_icon_link" href="post-single.html">
                                                                <img alt="Listen to the Wind Words, the Spirit blowing through the churches." src="{{asset('assets/images/shortcodes_sl1-370x209.jpg')}}">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="post_content isotope_item_content">
                                                ...
                                                <div class="post_item post_item_classic post_item_classic_3	odd">
                                                    <div class="post_featured">
                                                        ...
                                                        <div class="post_thumb" data-title="Want to Try an Online Church?‎">
                                                            <a class="hover_icon hover_icon_link" href="post-single.html">
                                                                <img alt="Want to Try an Online Church?‎" src="{{asset('assets/images/gallery-post-18-370x209.jpg')}}">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="post_content isotope_item_content">
                                                ...
                                                <div class="post_item post_item_classic post_item_classic_3	even last">
                                                    <div class="post_featured">
                                                        ...
                                                        <div class="post_thumb" data-title="Finding Yourself">
                                                            <a class="hover_icon hover_icon_link" href="post-single.html">
                                                                <img alt="Finding Yourself" src="{{asset('assets/images/gallery-post-2-370x209.jpg')}}">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="post_content isotope_item_content">
                                ...
                                <div class="slides swiper-wrapper">
                                    ...
                                    <div class="swiper-slide width_100_per" data-style="width:100%;">
                                        <div class="sc_testimonial_item">
                                            ...
                                            <div class="sc_testimonial_avatar">
                                                        <img alt="Community" src="{{asset('assets/images/home2_block1_img1-56x56.jpg')}}">
                                            </div>
                                            <div class="sc_testimonial_author">
                                                <span class="sc_testimonial_author_name">Hovard Gray</span>
                                                <span class="sc_testimonial_author_position">Pastor</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /Testimonials item -->
                                    ...
                                    <div class="swiper-slide width_100_per" data-style="width:100%;">
                                        <div class="sc_testimonial_item">
                                            ...
                                            <div class="sc_testimonial_avatar">
                                                <img alt="Thank you" src="{{asset('assets/images/shortcodes_team2-56x56.jpg')}}">
                                            </div>
                                            <div class="sc_testimonial_author">
                                                <span class="sc_testimonial_author_name">Herbert Wright</span>
                                                <span class="sc_testimonial_author_position">Executive Pastor</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /Testimonials item -->
                                    ...
                                    <div class="swiper-slide width_100_per" data-style="width:100%;">
                                        <div class="sc_testimonial_item">
                                            ...
                                            <div class="sc_testimonial_avatar">
                                                <img alt="I like your themes" src="{{asset('assets/images/shortcodes_team1-56x56.jpg')}}">
                                            </div>
                                            <div class="sc_testimonial_author">
                                                <span class="sc_testimonial_author_name">Elmer Black</span>
                                                <span class="sc_testimonial_author_position">Lead Teaching Pastor</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /Testimonials item -->
                                    ...
                                    <div class="sc_section join_us_custom_block_1">
                                        <div class="sc_section_inner">
                                            ...
                                            <h4 class="sc_title sc_title_regular underline margin_top_null margin_bottom_null tpl_light">
                                                <a class="tpl_light" href="#"><span class="__cf_email__" data-cfemail="31585f575e71485e4443425845541f525e5c">[email&#160;protected]</span></a>
                                            </h4>
                                        </div>
                                    </div>
